...
export default function Home() {
  ...
  const [dynamicWeatherData, setDynamicWeatherData] = useState<dynamicWeatherData>({
    temp: 0,
    feels_temp: 0,
    text: "",
    humidity: 0,
  ...
  // const goToDetailsPage = (item: WeatherData) => {
      ...
      <div>
        ...
        <div className='w-11/12 flex flex-col lg:flex-row  items-center justify-center gap-5 mt-16 m-auto'>
          ...
          <div className='backdrop-blur-xl bg-dull_grey/50 w-full lg:w-3/4 h-max lg:h-96 rounded-3xl flex  flex-col lg:flex-row justify-around items-center p-8'>
            <div>
              <h2 className='text-6xl xl:text-6xl 2xl:text-8xl  font-bold'>{weatherData.current.temp_c}°C</h2>
            ...
            <div className='w-max'>
              <img src={`/weather_icons/${weatherData.current.is_day ? "day" : "night"}/${weatherData.current.condition.code}.png`} alt="sunny" className='w-1/4 lg:w-1/2 m-auto mt-10 lg:mt-0' />
              <p className='text-center mt-2  lg:mt-6 font-medium text-3xl lg:text-5xl'>{weatherData.current.condition.text}</p>
            </div>
            <div className='grid grid-cols-2 items-center gap-12 gap-x-20 mt-8 lg:mt-0'>
              <div className='flex flex-col items-center gap-2'>
                <img src="/weather_icons/humidity.png" alt="humidity" className='w-1/2' />
                <div>
              ...
              <div className='flex flex-col items-center gap-2'>
                <img src="/weather_icons/wind.png" alt="wind" className='w-1/2 lg:w-14' />
                <div>
              ...
              <div className='flex flex-col items-center gap-2'>
                <img src="/weather_icons/pressure.png" alt="pressure" className='w-1/2' />
                <div>
              ...
              <div className='flex flex-col items-center gap-2'>
                <img src="/weather_icons/uv.png" alt="uv" className='w-1/2' />
                <div>
